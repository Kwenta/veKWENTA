...
contract OptimismGoerliDeploy is Script {
 ...
 * > forge script script/OptimismGoerliDeploy.s.sol:OptimismGoerliDeploy --rpc-url $OPTIMISM_GOERLI_RPC_URL --broadcast --verify -vvvv
 */
